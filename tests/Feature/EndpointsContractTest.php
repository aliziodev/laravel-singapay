...
it('calls the documented endpoint', function (Closure $call, string $method, string $url): void {
    ...
    'disbursement check beneficiary' => [fn (SingaPay $sp) => $sp->disbursement()->checkBeneficiary(['bank_code' => '014', 'bank_account_number' => '123']), 'POST', PAYMENT_HOST.'/api/v1.0/disbursement/'.ACC.'/check-beneficiary'],
